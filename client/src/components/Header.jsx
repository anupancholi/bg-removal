    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>  Drag, drop, and download – it's that simple.
                    <br className='max-sm:hidden' />No editing skills required. Let our AI handle the hard work.</p>
                <div>
